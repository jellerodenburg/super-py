...
### Dependencies:
#### Python
SuperPy was developed and tested with Python version 3.9.9
...
| -----------| --------------- | ---------: | ----------------------: | --------------: | ----------------: | -----------------------: |
| 2021-12-01 | 2022-01-01      |          1 |                  € 0.50 |          € 0.50 |            € 0.30 |                   € 0.20 |
...
optional arguments:
  ...
  -p PRICE, --price PRICE
                        price in euros (note: use decimal point as separator for cents)
